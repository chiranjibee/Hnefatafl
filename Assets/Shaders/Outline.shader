...
Shader "Custom/Outline"
{
	Properties
	{
		_OutlineColor ("Outline Color", Color) = (0, 0.5, 0.5, 0.5)
		_OutlineStrength ("Outline Strength", Range(0.5, 5.0)) = 2.0
	}
	...
	SubShader
	{
		...
		void surf(Input IN, inout SurfaceOutput o)
		{
			half outline = 1 - saturate(dot(normalize(IN.viewDir), o.Normal));
			o.Emission = _OutlineColor.rgb * pow(outline, _OutlineStrength);
		}
